...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { body: @about.body, status: @about.status, subbody: @about.subbody, subtitle: @about.subtitle, title: @about.title, user_id: @about.user_id } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { body: @about.body, status: @about.status, subbody: @about.subbody, subtitle: @about.subtitle, title: @about.title, user_id: @about.user_id } }
